...
<div class="product-card shadow">
    <a class="btn btn-primary mb-3 mt-3" href="/disposition/create">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
            <a class="btn badge bg-success" href="/disposition/{{$x->id}}">
            ...
            <a class="btn badge bg-warning" href="/disposition/{{$x->id}}/edit">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              Ubah</a>
           <form onclick="return confirm('apakah kamu yakin hapus data?')" action="/disposition/{{$x->id}}" method="post"
           class="d-inline">
           @csrf
           @method('delete')
