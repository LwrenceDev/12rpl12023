...
<head>
    ...
    <title>Laporan Userr</title>
</head>

<body>
        <h3>Laporan User <span class="text-primary">PT. Reignlf</span></h3>
    ...
    <div class="row">
        <div class="offset-9 text-center">
            ...
            <img class="" style="width: 100px" src="data:image/png;base64,{{DNS2D::getBarcodePNG($emailusr, 'QRCODE')}}" alt="barcode"   />
        </div>
</div>
