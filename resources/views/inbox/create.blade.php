...
<div class="product-card shadow">
    ...
    <form action="/inbox" class="title-section-content" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input value="{{old('tanggal_terima')}}" type="date" name="tanggal_terima" class="form-control  @error('tanggal_terima') is-invalid
            @enderror">
