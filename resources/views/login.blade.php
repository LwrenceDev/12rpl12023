                                ...
                                @endif
                                    <form class="mt-4 pt-2" action="/login" method="post">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input value="{{old('email')}}" type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="input-username"
                                        ...
                                        <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                            <input value="{{old('password')}}" type="password" name="password" class="form-control pe-5 @error('password') is-invalid @enderror" id="password-input"
